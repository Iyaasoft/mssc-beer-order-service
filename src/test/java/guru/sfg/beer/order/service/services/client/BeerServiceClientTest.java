...
class BeerServiceClientTest {
    ...
    public void ShouldRetrieveBeerDtoFromBeerService(WireMockRuntimeInfo wireMockRuntimeInfo) throws Exception { // ( WireMockRuntimeInfo wmRuntimeInfo) {
        ...
        BeerDto dto = BeerDto.builder().id(UUID.fromString("0a818933-087d-47f2-ad83-2f986ed087eb")).beerName("Pilsner").beerStyle(BeerStyleEnum.IPA).build();
        ...
        assertTrue(beerDto.getBeerStyle().equals(BeerStyleEnum.IPA));
    }
